        ...
        <div className="min-h-screen w-full flex flex-col bg-bg-page">
            ...
            >
                ...
                >
                    ...
                    <button
                        style={{ padding: '0.75rem 1rem' }}
                        className="w-full bg-accent hover:bg-accent-dark text-white font-semibold rounded-xl transition-all duration-300 active:scale-98 cursor-pointer mt-2 flex items-center justify-center"
                    >
                        Login
                    </button>
                </form>
                <p className="text-sm text-slate-400 text-center">
                    Don't have an account? <Link className="text-accent hover:underline font-semibold" to={"/register"} >Register</Link>
                </p>
            </div>
            </main>
        </div>
